  ...
  return (
    <div className="flex h-screen bg-slate-50">
      ...
      <aside className="w-60 flex-shrink-0 bg-slate-900 flex flex-col">
        ...
        {/* Upgrade CTA for free users (static for now) */}
        <div className="px-3 pb-2">
          <NavLink
            to="/billing"
            className="flex items-center justify-center gap-2 w-full px-3 py-2 rounded-lg text-xs font-semibold bg-gradient-to-r from-indigo-600 to-violet-600 text-white hover:from-indigo-500 hover:to-violet-500 transition-all"
          >
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-14 bg-white border-b border-slate-200 flex items-center px-6 flex-shrink-0">
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-800 font-semibold text-sm">Botix Dashboard</span>
          </div>
        </header>
